...
var (
	...
	certCommonName   = cmdCert.Flag.String("name", "Auray", "The common name of this certificate")
	certOrganization = cmdCert.Flag.String("org", "Auray", "Organization of the certificate")
